...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    ...
    <div class="card-body p-4 ">
        <form id="form-upsert-category" class="col-12"action=<?="/" . URL_SUBFOLDER . "/Admin/Category/UpdatePost" ?> method="post" class="row">
            <div cl ass="border p-3 ">
               
                <div class="form-group form-floating py-2 col-12">
                  <label class="ms-2">Name</label>
                  <input class="form-control border-0 shadow"  name="name" value="<?=$category["categorie_name"]?>"/>
                    
                </div>

                <input hidden name="id" value="<?=$category["id"]?>">
                <input hidden name="create_at" value="<?=(new DateTime($category["create_at"])) ? htmlspecialchars((new DateTime($category["create_at"]))  -> format('Y-m-d H:i:s')) : null?>">
                <div class="row pt-2">
